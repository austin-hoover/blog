...
![(Click to enlarge.)](images/fig_sns_diagram.png){#fig-sns fig-align=center}
...
![](images/fig_cov.png){#fig-cov width=65% fig-align=center}
...
![](images/fig_profiles.png){#fig-profiles width=75% fig-align=center}

Perfect agreement. The log-scale plots show agreement in low-density regions as well:

![](images/fig_profiles_log.png){#fig-profiles-log width=75% fig-align=center}
...
![](images/fig_proj2d.png){#fig-proj2d width=75% fig-align=center}
...
![](images/fig_exp02_proj2d.png){#fig-exp02-proj2d width=75% fig-align=center}
...
::: {layout-nrow=2}
![](images/fig_sim_proj2d_sim){width=75% fig-align=center}
![](images/fig_sim_profiles_sim){width=75% fig-align=center}
:::

::: {layout-nrow=2}
![](images/fig_sim_proj2d_gm){width=75% fig-align=center}
![](images/fig_sim_profiles_gm){width=75% fig-align=center}
:::

::: {layout-nrow=2}
![](images/fig_sim_proj2d_waterbag){width=75% fig-align=center}
![](images/fig_sim_profiles_waterbag){width=75% fig-align=center}
:::

::: {layout-nrow=2}
![](images/fig_sim_proj2d_hollow){width=75% fig-align=center}
![](images/fig_sim_profiles_hollow){width=75% fig-align=center}
:::
...
![](images/fig_sim_slice_sphere_all.png){#fig-slice width=50% fig-align=center}
