...
There are two important questions to answer in relation to painting. First, what is the target distribution in phase space? In the next section, I'll argue that *vortex distributions* could be useful in several contexts. Second, suppose we identify a target distribution: can we paint it? This is where I'll introduce *eigenpainting*, which is a method to paint vortex distributions.


## Vortex beam distributions {#sec-vortex}
