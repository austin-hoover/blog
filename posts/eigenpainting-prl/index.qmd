...
![Linear model of correlated eigenpainting: $J_x(t) = t \tilde{J}_x; J_y(t) = t \tilde{J}_y$. The injection point is plotted as a red dot. The time $t$ is scaled to the range [0, 1].](images/paint_corr.gif){#fig-paint-corr width=450px fig-align=left}
