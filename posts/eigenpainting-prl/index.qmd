...
To review: I've listed several possible applications of spinning beams: the production of flat beams in hadron colliders, the suppression of space charge structure resonances, and the reduction of space-charge-driven tune spread. Now we can introduce the *eigenpainting* method. I'll first generalize existing painting methods, *correlated* and *anti-correlated* painting, to include linear coupling between the two planes of motion. Once that's done, it will be clear that eigenpainting is a special case of both methods. If you're unfamiliar with the theory of coupled linear optics, see [this post](https://austin-hoover.github.io/blog/posts/2021-01-25_coupled-parametric-oscillators/).
...
Suppose we took the limit $\tilde{J}_y \rightarrow 0$. Now, regardless of which method we run, we get the same distribution



![Correlated and anti-correlated painting as $\tilde{J}_y \rightarrow 0$.](images/paint_eig.gif){#fig-paint-flat width=450px fig-align=left}
